...
(function (a, b) {
    ...
    function bi(a, b) {
        ...
        if (b.nodeType === 1) {
            ...
            if (c === "object") b.outerHTML = a.outerHTML; else if (c !== "input" || a.type !== "checkbox" && a.type !== "radio") {
                if (c === "options") b.selected = a.defaultSelected; else if (c === "input" || c === "textarea") b.defaultValue = a.defaultValue
    ...
    f.extend({
        ...
        g = c.createElement("select"), h = g.appendChild(c.createElement("options")), i = a.getElementsByTagName("input")[0], k = {
        ...
        valHooks: {
            option: {
                ...
                get: function (a) {
                    ...
                    var c = f.makeArray(b);
                    f(a).find("options").each(function () {
    ...
    f.each(["live", "die"], function (a, c) {
        ...
        c.documentElement.compareDocumentPosition ? r = function (a, b) {
            ...
            if (b) {
                ...
                try {
                    b.call(c.documentElement, "[placesSearchByKeyWord!='']:sizzle")
                } catch (f) {
                    e = !0
                }
            ...
            var a = c.createElement("div");
            a.innerHTML = "<div class='placesSearchByKeyWord e'></div><div class='placesSearchByKeyWord'></div>";
    ...
    bf.optgroup = bf.option, bf.tbody = bf.tfoot = bf.colgroup = bf.caption = bf.thead, bf.th = bf.td, f.support.htmlSerialize || (bf._default = [1, "div<div>", "</div>"]), f.fn.extend({
        text: function (a) {
            ...
            return this.googleMap(function () {
